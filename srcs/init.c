...
/*   Updated: 2016/03/17 17:39:37 by sganon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		init_env(t_env *e)
{
	...
	if (e->jul)
	{
		if (!(e->j->win = mlx_new_window(e->mlx, WIN_X, WIN_Y, "Julia")))
			return (0);
		init_julia(e->j, e);
	}
	if (e->sierp)
	{
		if (!(e->s->win = mlx_new_window(e->mlx, WIN_X, WIN_Y, "Sierpinski")))
			return (0);
		init_sierp(e->s);
	}
	if (e->ship)
	{
		if (!(e->sh->win = mlx_new_window(e->mlx, WIN_X, WIN_Y, "Burning Ship")))
			return (0);
		init_ship(e->sh, e);
	}
	return (1);
